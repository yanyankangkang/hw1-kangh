  ...
  public void processCas(CAS aCAS) throws ResourceProcessException {
   ...
   // HashMap<String, Integer> hash = new HashMap<String, Integer>();
    ...
    while(it.hasNext()){
      ...
      try {
        String ans = res.getID() + "|" + (res.getBegin()-res.getOutershift()) + " " + (res.getEnd() - res.getOutershift() - res.getInnershift() - 1)+ "|" + res.getWords();
        writer.write(ans + "\n");
      ...
      //  }
       ...
       System.out.println("Precision: " + P + " " + "Recall: "  +  R + " " + "F-Meause: " +  2*P*R/(P+R));
  }

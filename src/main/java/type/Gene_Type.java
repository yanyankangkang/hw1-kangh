...
/**
 * Gene record result generated by model Updated by JCasGen Tue Sep 23 00:57:24 EDT 2014
 * 
 * 
 */
public class Gene_Type extends Annotation_Type {
  ...
  public Gene_Type(JCas jcas, Type casType) {
    ...
    casFeat_Outershift = jcas.getRequiredFeatureDE(casType, "Outershift", "uima.cas.Integer",
            featOkTst);
    casFeatCode_Outershift = (null == casFeat_Outershift) ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_Outershift).getCode();

    casFeat_Innershift = jcas.getRequiredFeatureDE(casType, "Innershift", "uima.cas.Integer",
            featOkTst);
    casFeatCode_Innershift = (null == casFeat_Innershift) ? JCas.INVALID_FEATURE_CODE
            : ((FeatureImpl) casFeat_Innershift).getCode();
